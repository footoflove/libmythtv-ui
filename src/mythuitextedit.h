...
#else
class MPUBLIC MythUITextEdit : public MythUIType
#endif
{
    Q_OBJECT
  ...
  public:
   ...
   ~MythUITextEdit();
    ...
    void SetKeyboardSupport(bool isKeyboardSupport){m_isKeyboardSupport = isKeyboardSupport;}
