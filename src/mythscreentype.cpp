...
{
	qDebug("sizeof(m_FocusWidgetList) = %d\n", m_FocusWidgetList.count());
...
void MythScreenType::BuildFocusList(bool is_ContainSelf)
{
    m_FocusWidgetList.clear();
    m_CurrentFocusWidget = NULL;

    AddFocusableChildrenToList(m_FocusWidgetList, is_ContainSelf);
