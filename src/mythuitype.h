...
{
    Q_OBJECT
    Q_PROPERTY (QPoint Position READ GetQPosition WRITE SetQPosition);
  public:
    ...
    void SetQPosition(const QPoint &pos);
    virtual MythPoint GetPosition(void) const;
    QPoint GetQPosition(void) const;
    ...
    /*frank.zhou*/
    bool MoveTo(QPoint destXY, int msecs);
    /*~frank.zhou*/
  ...
  protected:
    ...
    void AddFocusableChildrenToList(QMap<int, MythUIType *> &focusList, bool is_ContainSelf);
