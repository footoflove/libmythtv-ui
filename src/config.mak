...
#FFMPEG_CONFIGURATION= --enable-opengl
#MYTHTV_CONFIG_MAK=1
#PREFIX=/usr/local
#prefix=/usr/local
#LIBDIRNAME=lib
...
#SRC_PATH="/root/frank/Trident/mythtv-0.24"
#SRC_PATH_BARE=/root/frank/Trident/mythtv-0.24
#BUILD_ROOT="/root/frank/Trident/mythtv-0.24"
#CC_IDENT=gcc 4.5.1 (Red Hat 4.5.1-4)
#ARCH=x86
#CC=gcc
#AS=gcc
#QMAKE=qmake
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -g -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -fPIC
ASFLAGS=   -g
CC_O=-o $@
CXXPPFLAGS= -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE
ECXXFLAGS=  -fomit-frame-pointer -pthread -g -Wall -Wno-switch -Wpointer-arith -Wredundant-decls -Wno-non-virtual-dtor -funit-at-a-time -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -O3 -Wmissing-declarations
LDFLAGS= -Wl,--warn-common -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/external/FFmpeg/libavutil -Wl,-Bsymbolic
...
EXTRALIBS= -lXvMCW -lXvMC -lXext -lXinerama -lXxf86vm -lXv -lXrandr -lmp3lame -lm -lasound -lasound -lfreetype -lm -pthread -lbz2 -lz -lrt  -ldl
#INSTALL=install
LIBTARGET=
...
SLIBNAME_WITH_MAJOR_QT=$${SLIBNAME_QT}.LIBMAJOR
#SLIB_CREATE_DEF_CMD=   ./configure  --enable-opengl{SLIB_CREATE_DEF_CMD}
#SLIB_EXTRA_CMD=   ./configure  --enable-opengl{SLIB_EXTRA_CMD}
#SLIB_INSTALL_EXTRA_CMD=   ./configure  --enable-opengl{SLIB_INSTALL_EXTRA_CMD}
#SLIB_UNINSTALL_EXTRA_CMD=   ./configure  --enable-opengl{SLIB_UNINSTALL_EXTRA_CMD}
SAMPLES=
libswscale_VERSION=0.11.0
libswscale_VERSION_MAJOR=0
libpostproc_VERSION=51.2.0
libpostproc_VERSION_MAJOR=51
libavcodec_VERSION=52.86.1
...
!CONFIG_LIBFAAD_LATM_DECODER=yes
...
CONFIG_OPENGL_VSYNC=yes
!CONFIG_QTDBUS=yes
CONFIG_QTWEBKIT=yes
!CONFIG_QUARTZ_VIDEO=yes
CONFIG_V4L=yes
!CONFIG_VALGRIND=yes
CONFIG_X11=no
CONFIG_XRANDR=yes
...
LAVFI_TESTS=
SEEK_TESTS=
CONFIG_OPENGL_LIBS= -lGL  -lGLU
#CCONFIG= linux release using_alsa using_oss using_backend using_dvb using_frontend using_hdhomerun using_hdpvr using_iptv using_ivtv using_joystick_menu using_lirc using_mheg using_opengl_video using_opengl_vsync using_qtwebkit using_v4l using_xrandr using_xv using_xvmc using_xvmc_vld using_xvmcw using_mythtranscode using_opengl using_ffmpeg_threads using_live using_mheg

CCONFIG= linux release using_alsa using_oss using_backend using_dvb using_frontend using_hdhomerun using_hdpvr using_iptv using_ivtv  using_lirc using_mheg using_qtwebkit using_v4l using_xv using_xvmc using_xvmc_vld using_xvmcw using_mythtranscode using_ffmpeg_threads using_live using_mheg

#CONFIG_DEFINES= MMX i386
#CONFIG_INCLUDEPATH= /usr/include /usr/local /usr/include
